...
contract ChainList is Ownable{
  ...
  function buyArticle(uint _id) payable public {
	//when calling require(to judge preconditions)/assert(for internal errors)/throw/revert functions and they fail:
    //values got refunded, state changes got reverted and function is interrupted
    //but gas up tp that point is not refunded
